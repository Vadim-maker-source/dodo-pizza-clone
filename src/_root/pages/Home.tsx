...
export type Filters = {
  ...
  ingredients: {
    ...
    'Сочные ананасы': boolean;
    'Фирменный томатный соус': boolean;
    'Фирменный соус альфредо': boolean;
    'Союс барбекю': boolean;
  };
};
...
const Home = () => {
  const [filters, setFilters] = useState<Filters>({
    ...
    ingredients: {
      ...
      'Сочные ананасы': false,
      'Фирменный томатный соус': false,
      'Фирменный соус альфредо': false,
      'Союс барбекю': false,
    }
  });
